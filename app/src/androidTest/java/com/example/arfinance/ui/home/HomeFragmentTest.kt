...
import com.example.arfinance.ui.MainActivity
...
class HomeFragmentTest{
    ...
    @Test
    fun test_isFabClickNavigateToAddTransaction(){
        val activityScenario = ActivityScenario.launch(MainActivity::class.java)

        onView(withId(R.id.add_transaction_fab)).perform(click())

        onView(withId(R.id.add_edit_transaction_root)).check(matches(isDisplayed()))
